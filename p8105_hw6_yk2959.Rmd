...
Model with  using head circumference, length, sex, and all interactions has the lowest RMSE, which tells us that it’s able to fit the dataset the best out of the three potential models.
